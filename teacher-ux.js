...
function version(){
 const badge=[...document.querySelectorAll('header span')].find(x=>/P\.O\.H\.A\.N\.G 2026/.test(x.textContent||''));if(badge)badge.textContent='P.O.H.A.N.G 2026 · v3.7.0 STABLE';
 document.title='Seoteuk Mate P.O.H.A.N.G v3.7.0 - Portfolio · Beginner UX · Cloud';
}
